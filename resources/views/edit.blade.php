    ...
    <div class="col-sm d-flex justify-content-center">
        <div class="card shadow p-3 mb-5 bg-white rounded w-100" style="width: 5rem;">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('pasiens.update', $item->id) }}" method="post">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_asuransi" value="{{ $item-> no_asuransi }}">
                                
                            </div>
                            <div class="form-group">
                                <label for="">Perusahaan Asuransi</label>
                                <input type="text" class="form-control" name="perusahaan_asuransi" value="{{ $item-> perusahaan_asuransi }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_rekam_medis" value="{{ $item-> no_rekam_medis }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="alamat" rows="3" cols="100">
                            {{ $item-> alamat }}
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_wa" value="{{ $item-> no_wa }}">
                        
                            <input type="hidden" class="form-control" name="barcode_link" value="{{ url("/pasiens/{$item->id}/edit") }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="alergi_obat" value="{{ $item-> alergi_obat }}">
                        </div>
                        <div class="form-group">
                            <label for="">Alergi Makanan</label>
                            <input type="text" class="form-control" name="alergi_makanan" value="{{ $item-> alergi_makanan }}">
                        </div>
                        <div class="form-group">
                            <label for="">Resiko Medis</label>
                            <input type="text" class="form-control" name="resiko_medis" value="{{ $item-> resiko_medis }}">
                        </div>
                        <div class="form-group">
                            <label for="">Berat Badan</label>
                            <input type="text" class="form-control" name="berat_badan" value="{{ $item-> berat_badan }}">
                        </div>
                        <div class="form-group">
                            <label for="">Tinggi Badan</label>
                            <input type="text" class="form-control" name="tinggi_badan" value="{{ $item-> tinggi_badan }}">
                        </div>
                        <div class="form-group">
